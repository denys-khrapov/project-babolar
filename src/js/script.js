document.addEventListener("DOMContentLoaded", function () {
	...
	function updateThemePreference() {
		...
		withoutTransition(() => {
			if (themeFromCookie === "dark") {
				...
				html.classList.toggle(themeClass, prefersDarkScheme)
				updateButtonState(prefersDarkScheme)
			}
		})
	}
	...
	const linksInfoBlock = document.querySelectorAll(".keep__item a")
	...
	function initSwiper() {
		...
		heroSwiper.on("slideChange", () => {
			...
			document
				.querySelectorAll(".pagination-hero__item")
				.forEach((el, index) => {
